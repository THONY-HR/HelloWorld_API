...
export const chatMistral = (req: Request, res: Response) => handleChatRequest(req, res, "cognitivecomputations/dolphin3.0-r1-mistral-24b:free", "API_KEY_OPEN_ROUTER");
export const chatDeepseek8B = (req: Request, res: Response) => handleChatRequest(req, res, "deepseek/deepseek-r1-distill-llama-8b", "API_KEY_OPEN_ROUTER");
export const chatDeepseek32B = (req: Request, res: Response) => handleChatRequest(req, res, "deepseek/deepseek-r1-distill-qwen-32b", "API_KEY_OPEN_ROUTER");
